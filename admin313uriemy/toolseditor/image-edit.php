...
//$verbose = true;
/* Note on image-edit and multi-shop: Although the table ps_image_shop contains a cover field, this is ignored by Prestashop and
   the cover for all shops is retrieved fromps_image. The only function of ps_image_shop is to select which images are available
   for a certain shop. However, if the cover is not available for a shop it is still shown */
