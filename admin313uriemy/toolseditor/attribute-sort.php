...
echo '<center><b><font size="+1">Attribute Sort</font></b></center>';
echo "Config:";
if($input['id_lang'] == "")
  echo " lang: ".$languagename." (used for names),";
echo "By default the attribute will move immediately after you entered the number. You can switch that off with the 'autosort' checkbox. Don't forget to submit to implement your changes!<br>";
echo 'If you don\'t see an effect after you submit you should refresh your page with ctrl-F5</td>';
