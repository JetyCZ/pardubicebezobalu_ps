...
At <a href="http://www.prestools.com/12-prestools-suite-plugins">www.Prestools.com</a> you can buy a plugin that allows you to process more than one product or all products of a category or manufacturer at a time.</p>';
  $disabled = 'disabled';
}
echo '<p>
...
<tr><td class=comment>Target id(s) </td><td><input name=mytargets size=25 onchange="unready()"> </td><td>enter one or more comma-separated product id\'s, category id\'s or manufacturer id\'s.</td></tr>
<tr><td>&nbsp;</td></tr>';
...
<tr><td colspan=3 class=comment>If a combination already exists, it will be left in place. However, you can choose below that some fields will be updated from the sample product.';
 echo '<br>If you select quantities they will be set to the standard value.';
echo '</td></tr>
