...
?>
  ...
  <b>Export</b>
  <br>Export will export all database tables to the "export" subdirectory of your Prestools directory. 
  <br>From there you can copy them (with FTP) to the "exim" subdirectory of Prestools on the target server.
