...
// "*********************************************************************";
if($_POST['searchterm'] != "")
  $ipaddress = sprintf("%u\n", ip2long($_POST['searchterm'])); /* convert negative values */
...
onclick="switchIp(); return false;">on this link</a>.<p>';
echo 'For addresses with colored backgrounds no referers are avialable. You can filter them out by clicking <a href="#"
