...
class SoapClientEET extends \SoapClient {
    ...
    public function __construct($service, Certificate $cert, $trace = FALSE) {
        if(Configuration::get('EETPLUS_TIMEOUT') && (int)Configuration::get('EETPLUS_TIMEOUT') > 0) {
           $connectTimeout = (int)Configuration::get('EETPLUS_TIMEOUT') * 1000;
    ...
    public function __doRequestByCurl($request, $location, $action, $version, $one_way = FALSE)
    {
        ...
        switch(Configuration::get('EETPLUS_SSLVERSION')) {
           case 5:  $options[CURLOPT_SSLVERSION] = 5; break;
           case 6:  $options[CURLOPT_SSLVERSION] = 6;  break;
        }
